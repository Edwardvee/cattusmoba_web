...
@section('http_body')
                ...
                <div class="col-md-3 ml-1 ">
                    <div class="container producto">
                        <div class="card">
                            ...
                            <div class="contentBx">
                                <h2>{{ $preference->items[0]->title }}</h2>
                                <div class="size">
                                    <p class="text-light">{{ $preference->items[0]->description }}</p>
                                </div>
                                <div class="color">
                                    <p class="text-light">ARS {{ $preference->items[0]->unit_price }}</p>
                                </div>
                                <a class="botonProducto" id="myBtn">Comprar</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal-content">
            ...
            <div class="container">
                <path d="M13.7678 10.2322L10.2322 13.7678M13.7678 13.7678L10.2322 10.2322" stroke="#1B1B1B"
                ...
                <input class="fondotarjeta" type="text" minlength="16" maxlength="16" id="card" name="card"
                    placeholder="0000 0000 0000 0000" />
                <br>
                <div class="exp-cvc">
                    <div class="expiration">
                        <label for="expiry">Fecha de expiración</label>
                        <input class="fondotarjeta" name="expiry" id="expiry" type="text" required
                            placeholder="00/00" />
                        <br>
                    </div>
                    <div class="security">
                        <label for="cvc">CVC</label>
                        <input class="fondotarjeta" type="text" minlength="3" maxlength="4" id="cvc"
                            name="cvc" placeholder="XXXX" />
                        <br>
                    </div>
                </div>
    ...
    <script>
        ...
        function botonmp(item) {
           ...
           case 0:
            ...
            break;
            case 1:  checkout = mp.checkout({
                preference: {
                    id: '<?php echo $preferences[1]->id;?>',
                },
            });
            break;
            case 2:  checkout = mp.checkout({
                preference: {
                    id: '<?php echo $preferences[2]->id;?>',
                },
            });
            break;
            case 3: checkout = mp.checkout({
                preference: {
                    id: '<?php echo $preferences[3]->id;?>',
                },
            });
            break;
          }
        ...
        btn.setAttribute("onclick", "botonmp(0)")
        ...
        var span = document.getElementsByClassName("close")[0];
        btn.setAttribute("onclick", "botonmp(1)")
        btn.onclick = function() {
            modal.style.display = "block";
            var h1 = document.getElementById("titulo-compra");
        ...
        var span = document.getElementsByClassName("close")[0];
        btn.setAttribute("onclick", "botonmp(2)")
        btn.onclick = function() {
            modal.style.display = "block";
            var h1 = document.getElementById("titulo-compra");
        ...
        var span = document.getElementsByClassName("close")[0];
        btn.setAttribute("onclick", "botonmp(3)")
        btn.onclick = function() {
            modal.style.display = "block";
            var h1 = document.getElementById("titulo-compra");
