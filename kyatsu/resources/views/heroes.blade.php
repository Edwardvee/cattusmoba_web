...
<body>
    ...
    <div class="row">
      <div class="col mt-3">
        <article class="card mt-1">
          <img class="card__background" src="img/jinx.png" width="1920" height="2193" />
      ...
      <div class="col mt-3">
        <article class="card">
          <img class="card__background" src="img/Aphelios.png" width="1920" height="2193" />
          <div class="card__content | flow">
            <div class="card__content--container | flow">
      ...
      <div class="col mt-3">
        <article class="card">
          <img class="card__background" src="img/vayne.png" width="1920" height="2193" />
          <div class="card__content | flow">
            <div class="card__content--container | flow">
  ...
  <div class="container">
    <div class="row">
      <div class="col mt-3">
        <article class="card">
          <img class="card__background" src="img/ezreal.png" width="1920" height="2193" />
          <div class="card__content | flow">
            <div class="card__content--container | flow">
      ...
      <div class="col mt-3">
        <article class="card">
          <img class="card__background" src="img/cait.png" width="1920" height="2193" />
          <div class="card__content | flow">
            <div class="card__content--container | flow">
      ...
      <div class="col mt-3">
        <article class="card">
          <img class="card__background" src="img/as.jpg" width="1920" height="2193" />
          <div class="card__content | flow">
            <div class="card__content--container | flow">
