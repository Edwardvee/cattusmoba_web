...
@section('http_body')
    ...
    <body>
        ...
        <div class="redes">
            ...
            <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="redes_icon"><img class="Red"
                    src="img/YouTube.png" width="40px"></a>
            <a href="youtube.com" class="redes_icon"><img class="Red" src="img/Facebook.png" width="40px"></a>
            <a href="https://www.instagram.com/dasomnya_industries/" class="redes_icon"> <img class="Red"
                    src="img/Instagram.png" width="40px"></a>
        </div>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-8 CrdRightSide">
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <button class="heroesDesc"
                                        onclick="cambiarImagen('img/cait.png', 'Texto de la imagen 1')">Daño<img
                                            class="butIcoHero" src="img/damage.png"></button>
                                    <button class="heroesDesc"
                                        onclick="cambiarImagen('img/india.jpg', 'Texto de la imagen 2')">Soporte</button>
                                    <button class="heroesDesc"
                                        onclick="cambiarImagen('img/placeholder2.png', 'Texto de la imagen 3')">Tanque</button>
                                </div>
